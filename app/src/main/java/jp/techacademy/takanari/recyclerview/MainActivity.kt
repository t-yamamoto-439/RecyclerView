...
//                    mTimer = Timer()
            ...
            recyclerView2.adapter = MainActivityAdapter { item ->
                //音を鳴らすコード書くとよい
                // 再生用AudioTrackは、同じサンプルレートで初期化したものを利用する
                // start sound
//                startbutton.setOnClickListener {
//                    mTimer = Timer()
            ...
            recyclerView3.adapter = MainActivityAdapter { item ->
                //音を鳴らすコード書くとよい
                // 再生用AudioTrackは、同じサンプルレートで初期化したものを利用する
                // start sound
//                startbutton.setOnClickListener {
//                    mTimer = Timer()
            ...
            recyclerView4.adapter = MainActivityAdapter { item ->
                //音を鳴らすコード書くとよい
                // 再生用AudioTrackは、同じサンプルレートで初期化したものを利用する
                // start sound
//                startbutton.setOnClickListener {
//                    mTimer = Timer()
            ...
            recyclerView5.adapter = MainActivityAdapter { item ->
                //音を鳴らすコード書くとよい
                // 再生用AudioTrackは、同じサンプルレートで初期化したものを利用する
                // start sound
//                startbutton.setOnClickListener {
//                    mTimer = Timer()
            ...
            recyclerView6.adapter = MainActivityAdapter { item ->
                //音を鳴らすコード書くとよい
                // 再生用AudioTrackは、同じサンプルレートで初期化したものを利用する
                // start sound
//                startbutton.setOnClickListener {
//                    mTimer = Timer()
            ...
            recyclerView7.adapter = MainActivityAdapter { item ->
                //音を鳴らすコード書くとよい
                // 再生用AudioTrackは、同じサンプルレートで初期化したものを利用する
                // start sound
//                startbutton.setOnClickListener {
//                    mTimer = Timer()
            ...
            recyclerView8.adapter = MainActivityAdapter { item ->
                //音を鳴らすコード書くとよい
                // 再生用AudioTrackは、同じサンプルレートで初期化したものを利用する
                // start sound
//                startbutton.setOnClickListener {
//                    mTimer = Timer()
            ...
            recyclerView9.adapter = MainActivityAdapter { item ->
                //音を鳴らすコード書くとよい
                // 再生用AudioTrackは、同じサンプルレートで初期化したものを利用する
                // start sound
//                startbutton.setOnClickListener {
//                    mTimer = Timer()
            ...
            recyclerView10.adapter = MainActivityAdapter { item ->
                //音を鳴らすコード書くとよい
                // 再生用AudioTrackは、同じサンプルレートで初期化したものを利用する
                // start sound
//                startbutton.setOnClickListener {
//                    mTimer = Timer()
            ...
            recyclerView11.adapter = MainActivityAdapter { item ->
                //音を鳴らすコード書くとよい
                // 再生用AudioTrackは、同じサンプルレートで初期化したものを利用する
                // start sound
//                startbutton.setOnClickListener {
